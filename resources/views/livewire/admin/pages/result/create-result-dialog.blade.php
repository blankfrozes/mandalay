<div>
    ...
    }" @open-create-dialog.window="open(event.detail)" @close-create-dialog.window="close()"
        x-cloak>
                    ...
                    <div
                        ...
                        <form wire:submit.prevent="submit" x-show="showModal" x-transition:enter="ease-out duration-200"
                            ...
                            <div class="flex items-center justify-between pb-3">
                                <p class="text-2xl font-bold">New Prize</p>
                            </div>

                            <div class="space-y-2">
                                <x-admin.input-date name="date" label="Date" placeholder="Choose Date" />

                                <x-admin.input name="prize.periode" label="Periode" readonly="true" />

                                <x-admin.input name="prize.first" label="1st" />

                                <x-admin.input name="prize.second" label="2nd" readonly="true" />

                                <x-admin.input name="prize.third" label="3rd" readonly="true" />
                            </div>

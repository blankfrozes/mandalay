<div>
    ...
    }" @open-delete-dialog.window="open(event.detail)" @close-delete-dialog.window="close()"
        x-cloak>
                    ...
                    <div
                        ...
                        <form wire:submit.prevent="submit" x-show="showModal" x-transition:enter="ease-out duration-200"
                            ...
                            <div class="flex items-center justify-center pb-3">
                                <p class="text-2xl font-bold">Delete Prize dengan periode <span
                                        class="text-red-700 underline">{{ $periode }}</span> ?</p>
                            </div>

                            @if (!$canDelete)
                                <p class="text-sm text-red-500">Cannot delete because data is in use!</p>
                            @endif
                            ...
                            <!--Footer-->
                            <div class="flex justify-center pt-2 mt-2 space-x-2">
                                <button type="button"
                                ...
                                <button type="submit"
                                    class="px-4 py-2 ml-2 text-white bg-red-700 rounded-lg hover:bg-red-500 disabled:bg-gray">
                                    Delete

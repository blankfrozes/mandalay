<x-app-layout>
    ...
    <livewire:admin.pages.result.result-table />
    <livewire:admin.pages.result.create-result-dialog />
    <livewire:admin.pages.result.edit-result-dialog />
    <livewire:admin.pages.result.delete-result-dialog />
</x-app-layout>
